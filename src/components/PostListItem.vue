    ...
    <div v-if="post && user" class="post">
        ...
        <div class="post-content">
            <template v-if="!editing">
              ...
              <a v-if="enablePostEditing" @click.prevent="editing = true" href="#" style="margin-left: auto;" class="link-unstyled" title="Make a change"><i class="fa fa-pencil"></i></a>
            </template>
...
export default {
  ...
  methods: {
    enablePostEdit () {
      if (this.authUser !== null && this.authUser['.key'] === this.post.userId) {
        this.enablePostEditing = true
      }
    }
  },
  created () {
